...
class SecureConfig {
    ...
    get iflytekConfig() {
        return {
            ...
            appid: process.env.IFLYTEK_APP_ID || "bde87bbc",
            apiSecret: process.env.IFLYTEK_API_SECRET || "ZTJhYzdhOGRmMWY1MThjZDE5MTQzYmI0",
            apiKey: process.env.IFLYTEK_API_KEY || "f29efd3e9602280f20471048a5dbd9a9",
            uri: "/v2/ots",
...
function performSecurityAudit() {
    ...
    sourceFiles.forEach(file => {
        if (fs.existsSync(file)) {
            ...
            if (content.includes('bde87bbc') || content.includes('ZTJhYzdhOGRmMWY1MThjZDE5MTQzYmI0')) {
